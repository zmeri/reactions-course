...
kcat = m.Param(value=10) # min^-1, Allikas: F. W. Wagner, A. R. Burger, and B. L. Vallee, “Kinetic properties of human liver alcohol dehydrogenase: oxidation of alcohols by class I isoenzymes,” Biochemistry, vol. 22, no. 8, pp. 1857–1863, Apr. 1983, doi: 10.1021/bi00277a018.
C_ensüüm = m.Param(value=2e-4) # mol/l, põhineb andmetele artiklist T. K. Li, W. F. Bosron, W. P. Dafeldecker, L. G. Lange, and B. L. Vallee, “Isolation of pi-alcohol dehydrogenase of human liver: is it a determinant of alcoholism?,” Proc Natl Acad Sci U S A, vol. 74, no. 10, pp. 4378–4381, Oct. 1977, doi: 10.1073/pnas.74.10.4378.
...
h_magu = m.Param(value=0.001) # min^-1
h_sool = m.Param(value=0.5) # min^-1
